...
Information
:   Data that has been given structure and context. Data that changes us.

Knowledge
:   Information gathered over time, framed by experience, values, context, insight and intuition.

Tabular Data
:   Data that has been useful by organizing it into
    a table. Typically, numerical data.

Recall back in chapter 1, when we discussed a [mental framework](https://itech.erickuha.com/book/ch1-computer-basics/1-knowledge.html) for information technology to exist in. Let's bring that back to our next topic: spreadsheets.

If I pull out my smartphone and check the weather, I will have a pretty
good idea about whether I need to wear a coat or bring an umbrella. This is called knowledge, but how did we get there? Have a little think about that before reading on.

What if I were to list the outside temperature at my home hour by hour,
...
**information** and maybe we can learn something deeper. Converting that
...
Perhaps I can go a step further and learn something about yearlong trends
...
This is where spreadsheets come in. Spreadsheet software does all of this and more. We are going to start
relatively simple, but our goal in this course is a deep enough
understanding of the software to do things like keep track of your
...
To follow along, copy this [example
file](https://bit.ly/3jY7mSB) to your Google Drive.

It should look like this:

![A simple budget](images/theory/1.png)
...
cell are now highlighted (in this case, the column heading C and the row
heading 2). Now, look at the name box in the top left corner; it now
...
In the next section, we will look at the basics of how to build a spreadsheet from scratch. Let's check it out!
